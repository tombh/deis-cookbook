...
# database
default.deis.database.image = 'deis/database:v0.1.1'
...
# cache
default.deis.cache.image = 'deis/cache:v0.1.1'
...
# server
default.deis.server.image = 'deis/server:v0.1.1'
...
# worker
default.deis.worker.image = 'deis/worker:v0.1.1'
...
# registry
default.deis.registry.image = 'deis/registry:v0.1.2'
...
# logger
default.deis.logger.image = 'deis/logger:v0.1.1'
